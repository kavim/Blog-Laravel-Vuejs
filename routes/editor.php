...
Route::get('get-post-cover/{id}', 'PostController@getPostCover');
Route::get('get-post-images/{id}', 'PostController@getPostImages');
Route::get('get-post-videos/{id}', 'PostController@getPostVideos');
